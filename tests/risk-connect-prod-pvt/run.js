...
/* Riskconnect PVT (Prod Environment)
 -----------------------------------------------------------------
Purpose:
    ...
    try {
        ...
        */
        await step(
            ...
            async () => {
                await driver.get(
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=Home"
                );

                await driver.wait(
                    until.elementLocated(By.id('main-menu-panel')),
                    30000
                );
            },
            { rethrowOnFail: true }
        ...
        */
        await step(
            ...
            async () => {
                await driver.get(
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?appId=2&widget=IncidentReview"
                );
            }
        );
        ...
        */
        await step(
            ...
            async () => {
                const pages = [
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=Responses",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=QuestionLibrary",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=QuestionAssignment",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=AllComplianceEntry"
                ];
        ...
        */
        await step(
            ...
            async () => {
                const pages = [
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=TagManagement",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=BusinessUnit",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=UserManagement",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=RiskEvents",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=Controls",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=RiskCauses",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=SelfAssessmentScales",
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?widget=AttachmentLibrary",
                    "https://erm2.protecht.com.au/uts/worms/client/app/react/RolesAndPermissions/rolesAndPermissions"
                ];
        ...
        */
        await step(
            ...
            async () => {
                await driver.get(
                    "https://erm2.protecht.com.au/uts/worms/client/app/widget.html?path=Applications%2FActions%2FAudit+Actions&widget=Dashboard"
                );
                await sleep(5000);
            }
        );
